...
public class UserTestData {
    ...
    public static final User updated_user1=new User(USER1_ID,"user1","semen","0ef78b48343037bbdcf70abee62238b4");
    ...
    public static final User newUser = new User(NEW_USER_ID,"user5","fedot","8debb68cd703b70fff71375d2d4d014b");
}
